...
const Header: React.FC = () => {
  return (
    <header className="flex justify-between items-center p-6 md:px-10 bg-background font-satoshiMedium border-b border-gray-300 text-primary">
      ...
      >
        ...
        <span className="absolute inset-0 w-full h-full bg-white border-2 border-white group-hover:bg-black"></span>
